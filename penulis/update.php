...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE penulis SET namapenulis='$namapenulis', alamatpenulis='$alamatpenulis', telppenulis='$telppenulis' WHERE kodepenulis='$kodepenulis'";
...
<body>
    <div class="container mt-4">
        ...
        $sql = "SELECT * FROM penulis WHERE kodepenulis='$kodepenulis'";
        ...
        <form action="update.php" method="POST">
            <div class="form-group">
                ...
                <input type="text" name="kodepenulis" class="form-control" value="<?php echo $row['kodepenulis']; ?>" readonly>
            </div>
            <div class="form-group">
