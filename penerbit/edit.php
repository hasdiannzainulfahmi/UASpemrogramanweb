...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE penerbit SET kodepenerbit='$kodepenerbit', namapenerbit='$namapenerbit', alamatpenerbit='$alamatpenerbit', telppenerbit='$telppenerbit' WHERE kodepenerbit='$kodepenerbit'";
    ...
    <div class="container mt-4">
        ...
        <form action="edit.php" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="telppenerbit" class="form-control" value="<?php echo $row['telppenerbit']; ?>" required>
            </div>
