...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO penerbit (kodepenerbit, namapenerbit, alamatpenerbit, telppenerbit) 
            VALUES ('$kodepenerbit', '$namapenerbit', '$alamatpenerbit', '$telppenerbit')";
    ...
    <div class="container mt-4">
        ...
        <form action="tambah.php" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="telppenerbit" class="form-control" required>
            </div>
